...
| Total runtime | 4s |
| Pipeline log | `/Users/kumar.aniket/Documents/personal/research/tourism-water-footprint/twf-calculation/logs/pipeline_run_1772539606.log` |
...
**Blue water TWF** moved from **5.68 billion m³** in 2015–16 to **6.69 billion m³** in 2019–20 and **6.24 billion m³** in 2021–22. Blue water intensity per tourist-day fell **35%** over the full period, driven predominantly by supply-chain structural shifts rather than on-site efficiency improvements.

Agriculture was the dominant upstream water source (71.4% of indirect blue TWF in 2021–22), entering the footprint through Leontief supply-chain propagation even though tourists purchase no raw agricultural goods directly. Inbound tourists generated **10–18×× more water** per tourist-day than domestic tourists, reflecting higher per-trip spending intensity in water-intensive categories.
...
> Direct water represents 9–14% of total blue TWF across all years. The indirect component's dominance reflects upstream agricultural supply chains supporting tourism food consumption.
...
|---|---|---|---|---|---|
| 2015 | 15.8197 | 0.5228 | 16.3425 | (base) |
| 2019 | 19.3328 | 0.9303 | 20.2631 | +24.0% |
| 2022 | 19.3849 | 0.8561 | 20.2410 | +23.9% |
...
> Total L/tourist/day fell **35%** (389 L/day) from 2015 to 2022. SDA shows this is predominantly a supply-chain structure (L-effect) improvement, not an on-site technology (W-effect) gain.
...
**Worked example — 2015:**
```
Domestic:    842 L/day  ×    5,012M days  =   4,220,020
Inbound:   8,628 L/day  ×      169M days  =   1,454,681
Total = 5,674,701 ÷ 5,180M days = 1,095 L/day  ≈  1,096 ✓
```
...
| Year | LOW (bn m³) | BASE (bn m³) | HIGH (bn m³) | Half-range ±% |
|---|---|---|---|---|
| 2015 | 0.3593 | 0.5228 | 0.7574 | ±38.1% |
| 2019 | 0.6141 | 0.9303 | 1.3245 | ±38.2% |
| 2022 | 0.5486 | 0.8561 | 1.1897 | ±37.4% |
...
| Year | LOW (bn m³) | BASE (bn m³) | HIGH (bn m³) | Half-range ±% |
|---|---|---|---|---|
| 2015 | 4.6766 | 5.6762 | 6.7469 | ±18.2% |
| 2019 | 5.5585 | 6.6911 | 7.9018 | ±17.5% |
| 2022 | 5.1643 | 6.2407 | 7.3432 | ±17.5% |
...
- Total TWF increased 9.9% from 2015 to 2022 (5.6762 → 6.2407 bn m³).
- Indirect water averaged 88% of total TWF.
...
1. **Blue TWF:** 5.68 → 6.69 → 6.24 bn m³ across the three fiscal years. Total TWF {{TWF_DIRECTION}} {{TWF_CHANGE_PCT}}% from 2015 to 2022.
...
5. **Inbound–domestic gap:** Inbound tourists use 10–18×× more blue water per tourist-day than domestic tourists. This gap is driven by spending intensity differences — not by different water intensities of Indian tourism infrastructure — and is therefore policy-tractable through product design.
...
```
[build_water_coefficients_20260303_210530] ✓  Agriculture: blue=579,823.8  green=2,036,908.0  green share=77.8% — reflects rainfed irrigation dominance in India
[build_water_coefficients_20260303_210530] ✓  Agriculture: blue=581,592.9  green=2,104,073.5  green share=78.3% — reflects rainfed irrigation dominance in India
[build_water_coefficients_20260303_210530] ✓  Agriculture: blue=533,476.1  green=1,943,817.1  green share=78.5% — reflects rainfed irrigation dominance in India
[build_water_coefficients_20260303_210646] ✓  Agriculture: blue=579,823.8  green=2,036,908.0  green share=77.8% — reflects rainfed irrigation dominance in India
[build_water_coefficients_20260303_210646] ✓  Agriculture: blue=581,592.9  green=2,104,073.5  green share=78.3% — reflects rainfed irrigation dominance in India
[build_water_coefficients_20260303_210646] ✓  Agriculture: blue=533,476.1  green=1,943,817.1  green share=78.5% — reflects rainfed irrigation dominance in India
[calculate_sda_mc_20260303_210532] ✓    #4: Repair & Maintenance of Motor Vehicle          dep=4.846%  water=0.00M m³
[calculate_sda_mc_20260303_210532] ✓    #5: Financial services                             dep=4.305%  water=0.00M m³
[calculate_sda_mc_20260303_210532] ✓    #4: Petroleum products → Repair & Maintenance of Motor Vehicle                  234.65M m³  (4.07%)
[calculate_sda_mc_20260303_210532] ✓    #3: Financial services                             dep=4.365%  water=0.00M m³
[calculate_sda_mc_20260303_210532] ✓    #4: Repair & Maintenance of Motor Vehicle          dep=3.873%  water=0.00M m³
[calculate_sda_mc_20260303_210532] ✓    #2: Petroleum products → Repair & Maintenance of Motor Vehicle                  402.83M m³  (7.48%)
[calculate_sda_mc_20260303_210532] ✓    #3: Financial services                             dep=4.991%  water=0.00M m³
[calculate_sda_mc_20260303_210532] ✓    #4: Repair & Maintenance of Motor Vehicle          dep=4.701%  water=0.00M m³
[calculate_sda_mc_20260303_210648] ✓    #4: Repair & Maintenance of Motor Vehicle          dep=4.846%  water=0.00M m³
[calculate_sda_mc_20260303_210648] ✓    #5: Financial services                             dep=4.305%  water=0.00M m³
[calculate_sda_mc_20260303_210648] ✓    #4: Petroleum products → Repair & Maintenance of Motor Vehicle                  234.65M m³  (4.07%)
[calculate_sda_mc_20260303_210648] ✓    #3: Financial services                             dep=4.365%  water=0.00M m³
[calculate_sda_mc_20260303_210648] ✓    #4: Repair & Maintenance of Motor Vehicle          dep=3.873%  water=0.00M m³
[calculate_sda_mc_20260303_210648] ✓    #2: Petroleum products → Repair & Maintenance of Motor Vehicle                  402.83M m³  (7.48%)
[calculate_sda_mc_20260303_210648] ✓    #3: Financial services                             dep=4.991%  water=0.00M m³
[calculate_sda_mc_20260303_210648] ✓    #4: Repair & Maintenance of Motor Vehicle          dep=4.701%  water=0.00M m³
[compare_years_20260303_210534] ⚠ WARNING: intensity DROP of -38.9% > 30%
[compare_years_20260303_210650] ⚠ WARNING: intensity DROP of -38.9% > 30%
[pipeline_run_1772539530] FAILED: compare
```
...
| Pipeline version | `v20260303-210646` |
